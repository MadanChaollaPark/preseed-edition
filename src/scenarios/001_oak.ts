...
export default () => {
  ...
  openDialog({
    content: `BRETT: PG! I am done waiting around!`,
    callback: () => {
      openDialog({
        content: `
          PG: BRETT, relax. I told both of you to meet me at the accelerator.;
        ...
        callback: () => {
          openDialog({
            ...
            callback: () => {
              openDialog({
                content: `PG: Because patience is also part of the game, BRETT. You will get your catch.`,
                callback: () => {
                  completeScenario(1);
                },
              });
